(function (global, factory) {
  ...
  var _config = {
    ...
    getUnit = function getUnit(value) {
      return (value = (value + "").substr((parseFloat(value) + "").length)) &&
        isNaN(value)
        ? value
        : "";
    },
        ...
        function () {
          return _isArray(min)
            ...
            : (roundingIncrement = roundingIncrement || 1e-5) &&
                ...
                Math.floor(
                  Math.round(
                    (min + Math.random() * (max - min)) / roundingIncrement
                  ) *
                    roundingIncrement *
                    returnFunction
                ) / returnFunction;
    ...
    _insertEase = function _insertEase(names, easeIn, easeOut, easeInOut) {
      ...
      var ease = { easeIn: easeIn, easeOut: easeOut, easeInOut: easeInOut },
        lowercaseName;
  ...
  var _win$1,
    ...
    _parseTransform = function _parseTransform(target, uncache) {
      ...
      cache.x =
        ((cache.xPercent =
          x && Math.round(target.offsetWidth / 2) === Math.round(-x) ? -50 : 0)
          ? 0
          : x) + px;
      cache.y =
        ((cache.yPercent =
          y && Math.round(target.offsetHeight / 2) === Math.round(-y) ? -50 : 0)
          ? 0
          : y) + px;
      cache.z = z + px;
    ...
    _addRawTransformPTs = function _addRawTransformPTs(
      ...
      var style = _tempDivStyler.style,
        ...
        endUnit;
      style.cssText =
        getComputedStyle(target).cssText + ";position:absolute;display:block;";
